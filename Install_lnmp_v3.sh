...
#安装依赖包
packs="gcc gcc-c++ openssl openssl-devel pcre pcre-devel"
...
mydir="mysql-5.6.35"
packs="gcc gcc-c++ gcc-g77 autoconf automake zlib* fiex* libxml* ncurses-devel libmcrypt* libtool-ltdl-devel* make cmake"
for pack in $packs;do
	yum -y install $pack
done
id mysql 
...
EOF
	...
	chkconfig --add mysqld
 	#开机启动
 	chkconfig mysqld on
	cp $myinstall/bin/mysql  /usr/bin/mysql
 	service mysqld start
